...
} from "./components/service-flip-card";
        ...
        <div className="lr-services-board-intro">
          <div className="lr-services-board-intro-body">
            <p className="lr-services-board-intro-para">
              ...
              en el momento en el que los necesites. Funcionan juntos pero también por separado y cada servicio puede resolver más de un problema. 
            </p>
          </div>
